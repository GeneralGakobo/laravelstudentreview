@extends('layouts.app')
@section('title', 'students selected courses')
@section('page-title', 'students selected courses')
...
<div class="container-fluid">
        ...
        <div class="card-header py-3">
            ...
            <div class="table-responsive">
                <a href="/add-studentselectedcourse"><button class="btn btn-primary">ADD</button></a>
        ...
        <form action="/edit-studentselectedcourse/{{$bb}}" method="post">
            @csrf
        ...
        function showDialog(id) {          
               ...
               console.log(id);
               var url =   "{{ url('/edit-studentselectedcourse-modal') }}";
             //  var data = "id="+id;

               $("#myModalLabel").html("Edit studentselectedcourse");
        ...
        function edit(id){
            ...
            var data = $("form").serialize();
            var url =   "{{ url('/edit-studentselectedcourse') }}";
...
<script src={{ asset("js/sweetalert.min.js")}}></script>
            ...
            $(document).on("click", "table.school tbody .unassigned", function(event) {
                var id = $(this).data('id').toString();
                    swal({
                    title: "Delete!",
                    text: "Are you sure you want to delete this student selected course!",
                    icon: "error",
                    buttons: [true, "Delete"],
                    })
                    .then((willDelete) => {
                        if (willDelete) {
                            window.location.href="{{url('/delete-studentselectedcourse/' )}}"+"/"+id;
                            swal({
                                title: "Success!",
