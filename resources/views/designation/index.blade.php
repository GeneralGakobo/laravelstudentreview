...
<div class="container-fluid">
        ...
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Designations</h6>  </div>

            <div class="card-body">
            <div class="table-responsive">
                <a href="/add-designation"><button class="btn btn-primary">ADD</button></a>
        ...
        <form action="/edit-designation/{{$bb}}" method="post">
            @csrf
        ...
        function showDialog(id) {          
               ...
               console.log(id);
               var url =   "{{ url('/edit-designation-modal') }}";
             //  var data = "id="+id;

               $("#myModalLabel").html("Edit Designation");
