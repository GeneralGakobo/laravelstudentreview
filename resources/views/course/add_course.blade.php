...
@endif
<a href="/course"><button class="btn btn-primary btn-small">VIEW</button></a>
    <!-- Begin Page Content -->
    ...
    $(document).ready(function() {
        ...
        $(add_button).click(function(e){ //on add input button click
            ...
            if(x < max_fields){ //max input box allowed
                ...
                '<label> department</label><select class="form-control" name="adjArr[]" placeholder="Select department" /><br>@foreach($Department as $value) <option value="{{$value->id}}">{{$value->department}}</option>@endforeach</select>  ' +
                    '<label> course code</label><input type="text"  class="form-control"  placeholder="Enter value" name="acjArr[]"  /><br> ' +
                    '<label> course Name</label><input type="text"  class="form-control"  placeholder="Enter value" name="abjArr[]"  /><br> ' +
