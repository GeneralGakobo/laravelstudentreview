@extends('layouts.app')
@section('title', 'Create Employmenttype')
@section('page-title', 'Create Employmenttype')
...
@endif
<a href="/employmenttype"><button class="btn btn-primary btn-small">VIEW</button></a>
...
<div class="row">
    <div class="card shadow col-md-12">
            <div class="card-body">
                <form method="POST" action="/add-employmenttype">
                    @csrf
        ...
        $(add_button).click(function(e){ //on add input button click
            ...
            if(x < max_fields){ //max input box allowed
                ...
                $(wrapper).append('<div class="col-md-4" style="padding-top:10px;padding-bottom:10px" >' +
                    '<label> employmenttype </label><input type="text"  class="form-control"  placeholder="Enter value" name="adjArr[]"  /><br> ' +
