@extends('layouts.app')
@section('title', 'Employmenttype')
@section('page-title', 'Employmenttype')
...
<div class="container-fluid">
        ...
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">employment_type</h6>  </div>

            <div class="card-body">
            <div class="table-responsive">
                <a href="/add-employmenttype"><button class="btn btn-primary">ADD</button></a>
        ...
        function showDialog(id) {          
               ...
               console.log(id);
               var url =   "{{ url('/edit-employmenttype-modal') }}";
             //  var data = "id="+id;

               $("#myModalLabel").html("Edit employment type");
        ...
        function edit(id){
            ...
            var data = $("form").serialize();
            var url =   "{{ url('/edit-employmenttype') }}";
...
<script src={{ asset("js/sweetalert.min.js")}}></script>
            ...
            $(document).on("click", "table.school tbody .unassigned", function(event) {
                var id = $(this).data('id').toString();
                    swal({
                    title: "Delete!",
                    text: "Are you sure you want to delete this employmenttype!",
                    icon: "error",
                    buttons: [true, "Delete"],
                    })
                    .then((willDelete) => {
                        if (willDelete) {
                            window.location.href="{{url('/delete-employmenttype/' )}}"+"/"+id;
                            swal({
                                title: "Success!",
