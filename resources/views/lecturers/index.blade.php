...
<div class="container-fluid">
        ...
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">lecturers</h6>  </div>

            <div class="card-body">
            <div class="table-responsive">
                <a href="/add-lecturer"><button class="btn btn-primary">ADD</button></a>
        ...
        <form action="/edit-lecturer/{{$bb}}" method="post">
            @csrf
        ...
        function showDialog(id) {          
               ...
               console.log(id);
               var url =   "{{ url('/edit-lecturer-modal') }}";
             //  var data = "id="+id;

               $("#myModalLabel").html("Edit lecturer");
...
<script src={{ asset("js/sweetalert.min.js")}}></script>
            ...
            $(document).on("click", "table.school tbody .unassigned", function(event) {
                var id = $(this).data('id').toString();
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            window.location.href="{{url('/delete-lecturer/' )}}"+"/"+id;
                            swal({
                                title: "Success!",
