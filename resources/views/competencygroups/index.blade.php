@extends('layouts.app')
@section('title', 'competencygroups')
@section('page-title', 'competencygroups')
...
<div class="container-fluid">
        ...
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">competency group</h6>  </div>

            <div class="card-body">
            <div class="table-responsive">
                <a href="/add-competencygroups"><button class="btn btn-primary">ADD</button></a>
        ...
        <form action="/edit-competencygroups/{{$bb}}" method="post">
            @csrf
        ...
        function showDialog(id) {          
               ...
               console.log(id);
               var url =   "{{ url('/edit-competencygroups-modal') }}";
             //  var data = "id="+id;

               $("#myModalLabel").html("Edit competency group");
        ...
        function edit(id){
            ...
            var data = $("form").serialize();
            var url =   "{{ url('/edit-competencygroups') }}";
...
<script src={{ asset("js/sweetalert.min.js")}}></script>
            ...
            $(document).on("click", "table.school tbody .unassigned", function(event) {
                var id = $(this).data('id').toString();
                    swal({
                    title: "Delete!",
                    text: "Are you sure you want to delete this competencygroup!",
                    icon: "error",
                    buttons: [true, "Delete"],
                    })
                    .then((willDelete) => {
                        if (willDelete) {
                            window.location.href="{{url('/delete-competencygroups/' )}}"+"/"+id;
                            swal({
                                title: "Success!",
