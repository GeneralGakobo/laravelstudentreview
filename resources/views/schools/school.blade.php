...
<div class="container-fluid">
        ...
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Schools</h6>  </div>

            <div class="card-body">
            <div class="table-responsive">
                <a href="/add-school"><button class="btn btn-primary">ADD</button></a>
        ...
        <form action="/edit-school/{{$bb}}" method="POST">
            @csrf
...
<script src={{ asset("js/sweetalert.min.js")}}></script>
            ...
            $(document).on("click", "table.school tbody .unassigned", function(event) {
                var id = $(this).data('id').toString();
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            window.location.href="{{url('/delete-school/' )}}"+"/"+id;
                            swal({
                                title: "Success!",
