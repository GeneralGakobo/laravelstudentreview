@extends('layouts.app')
@section('title', 'staffcategory')
@section('page-title', 'staffcategory')
...
<div class="container-fluid">
        ...
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">staff_category</h6>  </div>

            <div class="card-body">
            <div class="table-responsive">
                <a href="/add-staffcategory"><button class="btn btn-primary">ADD</button></a>
        ...
        <form action="/edit-staffcategory/{{$bb}}" method="post">
            @csrf
        ...
        function showDialog(id) {          
               ...
               console.log(id);
               var url =   "{{ url('/edit-staffcategory-modal') }}";
             //  var data = "id="+id;

               $("#myModalLabel").html("Edit staff category");
...
<script src={{ asset("js/sweetalert.min.js")}}></script>
            ...
            $(document).on("click", "table.school tbody .unassigned", function(event) {
                var id = $(this).data('id').toString();
                    swal({
                    title: "Delete!",
                    text: "Are you sure you want to delete this staffcategory!",
                    icon: "error",
                    buttons: [true, "Delete"],
                    })
                    .then((willDelete) => {
                        if (willDelete) {
                            window.location.href="{{url('/delete-staffcategory/' )}}"+"/"+id;
                            swal({
                                title: "Success!",
