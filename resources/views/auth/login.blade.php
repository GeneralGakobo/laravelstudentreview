              ...
              <div class="card-body">
                <form method="POST" action="{{ route('login') }}">
                  ...
                  <p class="mt-4 text-sm text-center">
                    ...
                    <a href="/register-student" class="text-primary text-gradient font-weight-bold">Sign up</a>
        ...
        <div class="container">
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-12 my-auto">
              <div class="copyright text-center text-white " style="align-text:center;">
                © <script>
                  document.write(new Date().getFullYear())
                </script>,
                <!-- Developed <i class="fa fa-heart" aria-hidden="true"></i> by
                <a href="https://www.bigbrainz.co.ke" class="font-weight-bold text-white" target="_blank">BigBrainz Inc.</a>
                 -->
              </div>
            </div>
