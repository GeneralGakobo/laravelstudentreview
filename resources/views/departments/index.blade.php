...
<div class="container-fluid">
        ...
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Departments</h6>  </div>

            <div class="card-body">
            <div class="table-responsive">
                <a href="/add-department"><button class="btn btn-primary">ADD</button></a>
        ...
        function showDialog(id) {          
               ...
               console.log(id);
               var url =   "{{ url('/edit-department-modal') }}";
             //  var data = "id="+id;
